...
public class SettlementTransactionController {
    ...
    @GetMapping("/{destinationAccountId}")
    public Page<SettlementTransactionProjection> getAllSettlementTransactionsForDestinationAccountId(
            @PathVariable UUID destinationAccountId, Pageable pageable) {
        return settlementTransactionService.getAllSettlementTransactionsForDestinationAccountId(destinationAccountId,
                pageable);
    }
}
